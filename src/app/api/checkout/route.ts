...
export async function POST(request: Request) {
  try {
    ...
    const discountInfo = data.get("discountInfo") as string || null;
        ...
        <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #1A1A1A; border: 1px solid #333; border-radius: 12px; overflow: hidden;">
          ...
          <div style="padding: 30px; color: #E8E0D0;">
            <table style="width: 100%; border-collapse: collapse; font-size: 15px;">
              ...
              ${discountInfo ? `<tr><td style="padding: 8px 0; color: #D4AF37; font-weight: bold;">Promo Applied</td><td style="padding: 8px 0; color: #D4AF37;">${discountInfo}</td></tr>` : ''}
